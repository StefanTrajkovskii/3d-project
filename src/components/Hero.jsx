  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
        ...
        <div data-aos="fade-right"
            ...
            {/* Main Heading */}
            <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font font-semibold tracking-wider my-8'>
                EMAIL FOR
                <br />
                 DEVELOPERS
            </h1>
            ...
            <p className='text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
                Experience a powerful email platform designed specifically for developers. Streamline your communication, integrate seamlessly with your workflow, and leverage advanced features that make email management effortless.
            </p>
        ...
        {/* 3D Robot  */}
        <Spline className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[2%] h-full' scene="https://prod.spline.design/Fj-J5049xBK54Rj1/scene.splinecode" />
